                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr class="align-middle">
                                                ...
                                                <div class="btn-group dropstart">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('barang.show', $item->IDBarang) }}">
                                                                View
                                                            </a>
                                                        </li>
                                                        <li><a class="dropdown-item"
                                                                href="{{ route('barang.edit', $item->IDBarang) }}">Edit</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" data-bs-toggle="modal"
                                                                data-bs-target="#delete-{{ $item->IDBarang }}"
                                                                href="#">
                                                                Delete
                                                            </a>
                                                        </li>
                                            ...
                                            <div class="modal fade" id="delete-{{ $item->IDBarang }}" tabindex="-1"
